...
import {GetMyEntities} from 'component/authService';
...
<>
  <Navbar collapseOnSelect expand="lg" bg="dark" fixed="top" variant="dark">
    ...
    <Nav.Link as={Link} to="/createRest" className="mr-xl-5 mr-md-4 my-auto" style={{color: "LightCoral", fontWeight:800}}>Create Restaurant</Nav.Link>
